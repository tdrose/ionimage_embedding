...
DSID = iie.datasets.KIDNEY_LARGE + iie.datasets.KIDNEY_SMALL + iie.datasets.BRAIN_SMALL + \
       iie.datasets.LIVER_SMALL + iie.datasets.LUNG_SMALL + iie.datasets.LUNG_LARGE
DSID = list(set(DSID))
...
dat = iie.dataloader.ColocNet_data.ColocNetData_discrete(
    ...
    fdr=.1, batch_size=1, min_images=min_images, maxzero=.99,
